...
public class FbaseHelper {
    ...
    private DatabaseReference mReferencesUser;
    ...
    public FbaseHelper() {
        ...
        mReferencesUser = mDatabase.getReference("UserId");
    }

    public void readUser(final DataStatus dataStatus){
        mReferencesUser.addValueEventListener(new ValueEventListener() {
            @Override
    ...
    public void updateUser(String key,User user,final DataStatus dataStatus){
        mReferencesUser.child(key).setValue(user)
    ...
    public void deleteUser(String key, final DataStatus dataStatus){
        mReferencesUser.child(key).setValue(null)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
